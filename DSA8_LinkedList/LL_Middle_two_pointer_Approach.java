...
public class LL_Middle_two_pointer_Approach {
    //initializing head
    Node head;
    ...
    //Linked List middle: Two pointer approach
    public void findMid(){
    ...
    public static void main(String[] args) {
        LL_Middle_two_pointer_Approach llist = new LL_Middle_two_pointer_Approach();
        llist.insertAtTheEnd(2);
        llist.insertAtTheEnd(4);
        llist.insertAtTheEnd(6);
        llist.insertAtTheEnd(8);
        llist.insertAtTheEnd(10);
        llist.insertAtTheEnd(11);
        llist.insertAtTheEnd(13);
